...
#define NUM_LOOPS 1 // number of times to run the test per input_size
#define NUM_INPUTSIZES 1 // number of input sizes to test
#define OUTPUT_FILE_PATH "results/timing_results.txt" // output size in bytes
#define VERBOSE   1 // print the input and output
